package com.javagyan.chatengine;
...
public class ChatEngineServlet extends HttpServlet {
    public static final Logger _log = Logger.getLogger(ChatEngineServlet.class.getName());
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            String errorMessage = "ERROR: ERROR: ERROR:Oops!!! something seems to be wrong with the your request paramenters. The correct usage is \n"
